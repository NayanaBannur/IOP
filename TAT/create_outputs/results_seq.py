...
from TAT.train_seq_pred import acc_metric, bleu_metric, \
...
all_results = []
folders = ['SMS-A-3-seq', 'SMS-A-3-seq-perm', 'SMS-A-3-seq-perm-pl',
           'CollegeMsg-3-seq', 'CollegeMsg-3-seq-perm', 'CollegeMsg-4-seq', 'CollegeMsg-4-seq-perm']
