...
# n_train_samples = len(train_set_indices)
# n_val_test_samples = len(test_set_indices)
# n_val_samples = int(0.5 * n_val_test_samples)
# n_test_samples = n_val_test_samples - n_val_samples
#
# print(f'{n_train_samples} train samples, {n_val_samples} val samples and {n_test_samples} test samples')
...
# hidden_dim1 = embedding_dim
# hidden_dim2 = 32
# model = nn.Sequential(
#             nn.Linear(set_indice_length * embedding_dim, hidden_dim1),
#             nn.LeakyReLU(negative_slope=0.2),
...
all_results.to_csv(f'./outputs/results_dyn_emb.csv', index=False)
